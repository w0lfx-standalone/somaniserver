...
* **Storage Mount** | `/mnt/swimming_pool/seafile` (TrueNAS) → `/mnt/swimming_pool/seafile` (Ubuntu)
...
![Truenas Dataset Permission](https://github.com/w0lfx-standalone/somaniserver/blob/main/assets/turenas_dataset_seafile_permission.png)
...
![ubuntu mounts](https://github.com/w0lfx-standalone/somaniserver/blob/main/assets/ubuntu_mounting_seafile.png)

Verified:

```
touch /mnt/swimming_pool/seafile/test
ls -l /mnt/swimming_pool/seafile
```

![ubuntu seafile test](https://github.com/w0lfx-standalone/somaniserver/blob/main/assets/ubuntu_test_seafile.png)
...
![ubuntu seafile docker](https://github.com/w0lfx-standalone/somaniserver/blob/main/assets/ubuntu_docker_seafile.png)

Volumes mapped to:

```
/mnt/swimming_pool/seafile/seafile-data
/mnt/swimming_pool/seafile/mariadb
/mnt/swimming_pool/seafile/config
```

![ubuntu seafile files](https://github.com/w0lfx-standalone/somaniserver/blob/main/assets/ubuntu_seafilefiles.png)
...
![seafile login](https://github.com/w0lfx-standalone/somaniserver/blob/main/assets/ubuntu_seafile_loginscreen)
...
* Installed Seafile desktop and mobile client
* Synced a test folder → instant reflection on server

![seafile phone](https://github.com/w0lfx-standalone/somaniserver/blob/main/assets/seafile_phone.jpg)
